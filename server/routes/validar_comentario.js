...
router.put("/", function(req,res){
    var query = `update libros_puntuaciones set status_comentario="${req.body.status_comentario}" WHERE id_libro="${req.body.id_libro}" AND id_perfil="${req.body.id_perfil}"`
